...
import com.mycompany.movieapi.exception.OAuth2AuthenticationProcessingException;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
        ...
        if (StringUtils.isEmpty(oAuth2UserInfo.getLogin())) {
            throw new OAuth2AuthenticationProcessingException("Login not found from OAuth2 provider");
        }

        Optional<User> userOptional = userService.getUserByUsername(oAuth2UserInfo.getLogin());
        User user;
